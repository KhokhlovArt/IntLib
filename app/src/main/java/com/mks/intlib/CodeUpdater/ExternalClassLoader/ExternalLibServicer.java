package com.mks.intlib.CodeUpdater.ExternalClassLoader;
...
public class ExternalLibServicer {
    ...
    private ExternalLibServicer(Context cnt){
        ...
        String dexHashCode = SharedPreferencesServicer.getPreferences(cnt, C.SPF_SESSION_DEX_HASH, C.SPF_KEY_DEX_HASH, null);
...
//        }
    ...
    {
        return "" + C.DexFilePath(cnt);
    }

    public static String getDexFilePathZip(Context cnt)
    {
        return "" + C.DexFilePathZip(cnt);
    }
